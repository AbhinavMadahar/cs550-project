...
'''This recommendation recommends the similar movies on the basis of the metadata of
the movie. The credits and the keywords are obtained from the credits.csv, which has the details about the cast and crew, and keywords.csv,
which has the movie plot as keywords. These files are then merged for the further process. Cosine similiarity matrix is found on
the basis of the similar words in the keyowrds, cast and crew of the movie and the genre of the movie.'''

def get_recommendations_keywords(movie):
